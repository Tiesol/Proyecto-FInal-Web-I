    ...
    <article class="campaign_grid_card">
      ...
      <div class="campaign_grid_content">
        ...
        <div class="campaign_grid_footer">
          ...
          <a href="campaign-detail.html?id=${campaign.id}" class="btn_more_details">Ver más</a>
        </div>
      </div>
    </article>
  `;
      ...
      <div class="campaign_overlay">
        <div class="campaign_content">
          ...
          <div class="campaign_progress">
            ...
            <a href="campaign-detail.html?id=${campaign.id}" class="btn_view_campaign">Ver Campaña</a>
          </div>
        </div>
      </div>
    </div>
